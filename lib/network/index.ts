...
export class Networking extends Construct {
  ...
  constructor(scope: Construct, id: string, props: NetworkingProps) {
    ...
    const foundationalLlmChatAppSecurityGroup = new ec2.SecurityGroup(
      this,
      "foundationalLlmChatAppSecurityGroup",
      {
        vpc: this.vpc,
    ...
    this.publicLoadBalancer = new elbv2.ApplicationLoadBalancer(
      this,
      "foundationalLlmChatPublicLoadBalancer",
      {
        vpc: this.vpc,
        internetFacing: true,
    ...
    // enabling logs
    this.publicLoadBalancer.logAccessLogs(
      logBucket,
    ...
    const stickyCachePolicy = new cloudfront.CachePolicy(
      this,
      "stickyCachePolicy",
      {
    ...
    this.cloudFrontDistribution = new cloudfront.Distribution(
      this,
      "foundationalLlmChat_distribution",
      {
        defaultBehavior: {
          origin: new origins.LoadBalancerV2Origin(this.publicLoadBalancer, {
    ...
    this.cloudFrontDistributionURLParameter = new ssm.StringParameter(
      this,
      "cf_distribution_url",
      {
    ...
    new CfnOutput(this, "FoundationalLlmChatDNS", {
      ...
      description:
        "DNS name of the your distribution, use it to access to your application",
    });
  }
}
