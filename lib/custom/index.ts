...
export class CustomResources extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CustomResourcesProps) {
    ...
    const getCloudFrontPrefixList = new lambda.Function(
      this,
      "getCloudFrontPrefixList",
      {
        code: lambda.Code.fromAsset(
          "./custom_resources/lambda/cloudFront_get_prefix_list",
        ),
        ...
        logGroup: new logs.LogGroup(
          this,
          `${props.prefix}getCloudFrontPrefixListLogs`,
          {
    ...
    getCloudFrontPrefixList.addToRolePolicy(
    ...
    const lambdagetCloudFrontPrefixListProvider = new customResources.Provider(
      this,
      "lambdagetCloudFrontPrefixListProvider",
      {
    ...
    const lambdagetCloudFrontPrefixListResult = new CustomResource(
      this,
      "lambdagetCloudFrontPrefixListResult",
      {
    ...
    this.cloudFrontPrefixList =
      lambdagetCloudFrontPrefixListResult.getAttString("prefix_lists");
  }
}
