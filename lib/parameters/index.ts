...
export class Parameters extends Construct {
  ...
  constructor(scope: Construct, id: string, props: ParametersProps) {
    ...
    this.dynamodb_dataLayer_name_parameter = new ssm.StringParameter(this, "DynamoDBDataLayerNameParameter", {
    ...
    this.s3_dataLayer_name_parameter = new ssm.StringParameter(this, "S3DataLayerNameParameter", {
